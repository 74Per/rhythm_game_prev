...
song_list = [
    {'path' : r"C:\Users\User\Documents\dev\이찬우\rhythm_game\songs\Newjeans.mp3", 'name' : 'Newjeans'},
    {'path' : r"C:\Users\User\Documents\dev\이찬우\rhythm_game\songs\ETA.mp3", 'name' : 'ETA'},
    {'path' : r"C:\Users\User\Documents\dev\이찬우\rhythm_game\songs\ASAP.mp3", 'name' : 'ASAP'}
]
...
#####################################################################################################
        ...
        #######################################################################################################
        keys[1] += (keyset[1]-keys[1])/ (4 * (maxframe / fps))      
        keys[2] += (keyset[2]-keys[2])/ (4 * (maxframe / fps))
        keys[0] += (keyset[0]-keys[0])/ (4 * (maxframe / fps))
        keys[3] += (keyset[3]-keys[3])/ (4 * (maxframe / fps)) 
        #######################################################################################################
        if Time > combo_time:
